...
class Postpage extends React.Component {
  ...
  render() {
    if (this.state.pulledData === false) {
      //Waits indefinitely for the data
      var max = 5;
      ...
      if (randInt == 0) {
        return (
          <Box>
            ...
            <h1 className='center'>
              "Here's Uranus, where the alien race Uranium is from! Except I'm
              lying"
            </h1>
            <Box h='20px'></Box>
          </Box>
        ...
        <Box>
          ...
          <Box className='containerDown'>
            ...
            <Box className='containerAcross'>
              ...
              <Box mt='50px' w='500px' h='350px' bg='gray'>
                {' '}
                {/* Gradebox */}
                <h2></h2>
              </Box>
              <Box mt='50px' w='400px' h='350px' bg='#A9A9A9'>
                {' '}
                {/* for horizontal line*/}
              </Box>
              ...
              <Box className='containerDown'>
                {/* Statbox */}
                <Box ml='50px' w='400px' h='50px' bg='Black'>
                  {' '}
                  {/* leaderboards*/}
                </Box>
                <Box ml='50px' w='400px' h='450px' bg='#A9A9A9'>
                  {' '}
                  {/* leaderboards*/}
                </Box>
              </Box>
            ...
            <Box h='60px'></Box>
            <Box className='containerAcross'>
              <Box ml='250px' w='200px' h='40px' bg='gray'></Box>{' '}
              {/* for horizontal line*/}
              <Box ml='5px' w='200px' h='40px' bg='#A9A9A9'></Box>{' '}
              {/* for horizontal line*/}
            </Box>
            <Box h='60px'></Box>
          </Box>
